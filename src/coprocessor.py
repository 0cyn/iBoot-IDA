...
class CortexMFirmware:
    def __init__(self, auto=False):
        ...
        It's probably a good idea too backup your IDB files before trying this out.
        ...
        if not self.verify_processor_settings():
            ...
            print("Please set processor type to ARM, and ARM architecture options to ARMv7-M (or other "
                  "valid Cortex architecture)")
    ...
    def annotate_vector_table(self, vtoffset=0x0000000000):
        ...
        https://infocenter.arm.com/help/index.jsp?topic=/com.arm.doc.dui0552a/BABIFJFG.html

        Vector tables can appear in multiple places in device flash
